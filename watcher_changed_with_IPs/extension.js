...
async function onCheckServerConnection(){
    ...
    loginData.append('username', "202681b76cea"); //vscode.workspace.getConfiguration('watcher').get('enrollment')
    loginData.append('password', "securepassword123"); //vscode.workspace.getConfiguration('watcher').get('password')
